...
import { PreExecutionPolicyEngine, AgentIdentity, PolicyDecision } from '@svgph/sdk';
import { WorkflowPersistence, WorkflowDefinition, WorkflowRun, BUILTIN_TEMPLATES, WorkflowTemplate, WorkflowScheduler, SchedulerEntry } from '@deepclaw/core';
  ...
  private _setupRoutes(): void {
    ...
    this.app.post('/api/v1/credentials', async (c) => {
      try {
        ...
        const credential = this.credentials.create(body.name, body.type, body.data);
