...
import { DeepClawGateway } from '../../src/gateway/index.js';
import { PreExecutionPolicyEngine, AgentIdentity } from '../../src/sdk/index.js';
...
describe('DeepClawGateway', () => {
  ...
  describe('observability endpoints', () => {
    test('exports OTel spans', async () => {
      ...
      const otelData = await otelResponse.json() as any;
